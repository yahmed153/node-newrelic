...
class HealthReporter {
  ...
  constructor({
    agentConfig = { agent_control: {fleet_id: process.env.NEW_RELIC_AGENT_CONTROL_FLEET_ID, health: {delivery_location: process.env.NEW_RELIC_AGENT_CONTROL_HEALTH_DELIVERY_LOCATION} } },
    ...
    this.#logger.info(`Agent config ${agentConfig}`)
